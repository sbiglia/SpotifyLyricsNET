...
namespace Spotify_Lyrics.NET_Helper_UWP
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Spotify Lyrics .NET Helper UWP | " + VERSION + " - " + BUILD);
            Console.WriteLine("This application launches Spotify Lyrics .NET UWP as soon as you launch Spotify.");
            Console.ReadLine();
        }
